...
|----------------------+---------------------------|
| try2-named-comment1  | try2-named-comment1-value |
| try2-named-comment2  | try2-named-comment2-value |
| try2-named-comment3  | try2-named-comment3-value |
| try2-named-comment4  | try2-named-comment4-value |
| try2-named-comment5  | try2-named-comment5-value |
...
:RESULTS:
#+NAME: try2-named-comment1
#+BEGIN_COMMENT
try2-named-comment1-value
#+END_COMMENT

#+CALL: try2-named-comment1()

#+NAME: try2-named-comment2
#+BEGIN_COMMENT
try2-named-comment2-value
#+END_COMMENT

#+CALL: try2-named-comment2()

#+NAME: try2-named-comment3
#+BEGIN_COMMENT
try2-named-comment3-value
#+END_COMMENT

#+CALL: try2-named-comment3()

#+NAME: try2-named-comment4
#+BEGIN_COMMENT
try2-named-comment4-value
#+END_COMMENT

#+CALL: try2-named-comment4()

#+NAME: try2-named-comment5
#+BEGIN_COMMENT
try2-named-comment5-value
#+END_COMMENT

#+CALL: try2-named-comment5()
